...
import com.example.spring2023.domain.MyDto18Supplier;
import com.example.spring2023.domain.MyDto19Employee;
...
public class Controller24 {
    ...
    @PostMapping("sub2")
    public void method2(MyDto18Supplier supplier) throws SQLException {
        String sql = """
    ...
    @PostMapping("sub4")
    public void method5(MyDto19Employee employee) throws SQLException {
        String sql = """
