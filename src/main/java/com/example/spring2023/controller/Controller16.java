...
//    App은 servletcontext가 담당한다
    ...
    public void method1(Model model, HttpSession session){
       ...
       session.setAttribute("sessionAttr1", "휴식");
       application.setAttribute("appAttr1","보름달");

       model.addAttribute("attr1","추석");
       session.setAttribute("attr1", "휴식");
       application.setAttribute("attr1","보름달");
    }

    @GetMapping("sub2")
//    세션 보다 app가 더 넓은 영역인 이유
    ...
    public String method5(){
        ...
        return "/main16/sub5"; // view nama이 된다
    }
    ...
    public String method6(){
        ...
        // redirection
        // 다른 곳(location)으로 가!! 라는 응답(response, 3xx(보통은 302로 간다) )
    ...
    //첫 요청을 sub14로 보냈을때 foodList를 작성해서 sub15에서 attribute를 꺼내라
    @GetMapping("sub14")
    public String method14(String food, RedirectAttributes rttr){
        List<String> foodList = List.of("버거","라면","김치");
