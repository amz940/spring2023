...
import com.example.spring2023.domain.MyDto14;
...
public class Controller17 {
    ...
    public String newPost(MyDto14 post, RedirectAttributes rttr){
        Object posts = application.getAttribute("post");
        List<MyDto14> list = (List<MyDto14>) posts;
        list.add(post);

        rttr.addFlashAttribute("message", "새 글 잘 들어감");
        rttr.addAttribute("id",list.size()-1);
//        return "redirect:/main17/list";
        return "redirect:/main17/view?id=";
    }
